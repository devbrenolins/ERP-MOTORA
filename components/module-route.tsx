...
const titles: Record<string, string> = {
  estoque: "Estoque", pagamentos: "Pagamentos", "fluxo-caixa": "Fluxo de caixa", caixa: "Caixa",
  relatorios: "Relatórios financeiros", crm: "CRM", bi: "BI da oficina", "portal-acessos": "Portal do cliente",
  "retornos-garantia": "Retornos em garantia", notificacoes: "Notificações", auditoria: "Auditoria",
  configuracoes: "Configurações", privacidade: "Privacidade e LGPD", perfis: "Cargos e acessos",
};

export function moduleTitle(module: string) { return titles[module] ?? modules[module]?.title ?? "Operação"; }
