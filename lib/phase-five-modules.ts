...
export const phaseFiveModules: Record<string, ModuleConfig> = {
  segmentos: {
    ...
    phaseLabel:"Fase 5 • CRM",subtitle:"Organize públicos manuais e critérios de relacionamento para campanhas e acompanhamento.",
    fields:[
  ...
  garantias: {
    slug:"garantias",table:"warranties",title:"Garantias",singular:"garantia",branchColumn:"branch_id",phaseLabel:"Fase 5 • Pós-venda",subtitle:"Controle cobertura por serviço, peça, ordem, prazo e quilometragem.",defaults:{status:"active"},
    fields:[
  ...
  frotas: {
    slug:"frotas",table:"fleet_contracts",title:"Frotas e convênios",singular:"contrato",branchColumn:"branch_id",phaseLabel:"Fase 5 • Frotas",subtitle:"Contratos, limites, aprovação e fechamento mensal para clientes corporativos.",defaults:{status:"active"},
    fields:[
  ...
  "motoristas-frota": {
    slug:"motoristas-frota",table:"fleet_drivers",title:"Motoristas de frota",singular:"motorista",branchColumn:"branch_id",phaseLabel:"Fase 5 • Frotas",subtitle:"Cadastre condutores autorizados em cada contrato.",
  ...
  "veiculos-frota": {
    slug:"veiculos-frota",table:"fleet_vehicles",title:"Veículos de frota",singular:"veículo vinculado",branchColumn:"branch_id",phaseLabel:"Fase 5 • Frotas",subtitle:"Vincule veículos, limites, centros de custo e autorização.",
  ...
  "modelos-mensagem": {
    slug:"modelos-mensagem",table:"message_templates",title:"Modelos de mensagem",singular:"modelo",branchColumn:"branch_id",phaseLabel:"Fase 5 • Automações",subtitle:"Crie comunicações com variáveis como nome, veículo, placa, OS e valor.",
  ...
  automacoes: {
    slug:"automacoes",table:"automation_rules",title:"Automações de pós-venda",singular:"automação",branchColumn:"branch_id",phaseLabel:"Fase 5 • Automações",subtitle:"Enfileire lembretes e comunicações somente para clientes com consentimento.",action:{label:"Executar ciclo",rpc:"run_automation_cycle",confirm:"Executar agora as regras ativas desta filial?"},
  ...
  integracoes: {
    slug:"integracoes",table:"integration_connections",title:"Integrações",singular:"integração",branchColumn:"branch_id",phaseLabel:"Fase 5 • Integrações",subtitle:"Registre provedores e endpoints sem armazenar credenciais no navegador.",defaults:{status:"draft"},
